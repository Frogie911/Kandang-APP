    ...
    <AdminLayout title="Admin Dashboard">
      ...
      <section className="space-y-2">
        <div className="flex justify-between items-start">
          <div>
            <h2 className="font-headline-sm text-headline-sm">Selamat Datang, Admin</h2>
            <p className="font-body-md text-on-surface-variant text-[14px]">Senin, 24 Mei 2024</p>
          </div>
      ...
      <section className="space-y-3">
        <h3 className="font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider">Status Lantai</h3>
        <div className="space-y-3">
          <div className="floor-card bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between active:bg-surface-container-low transition-colors cursor-pointer">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary flex items-center justify-center text-on-primary font-bold">L1</div>
              <div>
                <p className="font-label-lg text-on-surface">Lantai 1</p>
                <p className="text-label-md text-on-surface-variant">Pakan: 400kg | Mati: 2</p>
              </div>
            </div>
          ...
          <div className="floor-card bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between active:bg-surface-container-low transition-colors cursor-pointer">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary flex items-center justify-center text-on-primary font-bold">L2</div>
              <div>
                <p className="font-label-lg text-on-surface">Lantai 2</p>
                <p className="text-label-md text-on-surface-variant">Pakan: 350kg | Mati: 8</p>
              </div>
            </div>
            <span className="material-symbols-outlined text-outline">chevron_right</span>
          </div>
          <div className="floor-card bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center justify-between active:bg-surface-container-low transition-colors cursor-pointer">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-lg bg-primary flex items-center justify-center text-on-primary font-bold">L3</div>
              <div>
                <p className="font-label-lg text-on-surface">Lantai 3</p>
                <p className="text-label-md text-on-surface-variant">Pakan: 100kg | Mati: 2</p>
              </div>
            </div>
            <span className="material-symbols-outlined text-outline">chevron_right</span>
          </div>
      ...
      {/* Recent Activity */}
      <section className="space-y-3">
        <h3 className="font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider">Aktivitas Terkini</h3>
          ...
          <div className="divide-y divide-outline-variant">
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-grow">
                <p className="font-label-md text-on-surface">Input pakan Lantai 1 oleh <strong>Budi</strong></p>
                <p className="text-[10px] text-outline mt-1">15 menit yang lalu</p>
              </div>
            </div>
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-grow">
                <p className="font-label-md text-on-surface">Pemberian vitamin oleh <strong>Siti</strong></p>
            ...
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-grow">
                <p className="font-label-md text-on-surface">Pencatatan mortalitas oleh <strong>Agus</strong></p>
            ...
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-grow">
                <p className="font-label-md text-on-surface">Stok pakan baru masuk oleh <strong>Admin</strong></p>
            ...
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-grow">
                <p className="font-label-md text-on-surface">Cek kebersihan kandang oleh <strong>Yanto</strong></p>
