  ...
  return (
    <AdminLayout title="Laporan & Export" showBack>
      ...
      <section className="bg-surface-container-lowest border border-outline-variant rounded-card p-4 space-y-4">
        <h2 className="font-label-lg text-label-lg text-on-surface-variant">Pilih Periode Laporan</h2>
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            <label className="font-label-md text-label-md text-on-surface-variant">Dari Tanggal</label>
            <div className="relative flex items-center">
              <span className="material-symbols-outlined absolute left-3 text-outline text-[20px]">calendar_month</span>
              <input 
          ...
          <div className="space-y-1">
            <label className="font-label-md text-label-md text-on-surface-variant">Sampai Tanggal</label>
            <div className="relative flex items-center">
              <span className="material-symbols-outlined absolute left-3 text-outline text-[20px]">calendar_month</span>
              <input 
                className="w-full h-touch-target-min pl-10 border border-outline-variant rounded-ui-element bg-surface-container-lowest focus:ring-2 focus:ring-primary focus:border-primary text-body-md outline-none" 
        ...
        <div className="space-y-1">
          <label className="font-label-md text-label-md text-on-surface-variant">Batch</label>
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          <button className="px-4 py-2 rounded-full border border-outline-variant text-label-lg hover:bg-surface-container-low transition-colors">7 Hari</button>
          <button className="px-4 py-2 rounded-full border border-outline-variant text-label-lg hover:bg-surface-container-low transition-colors">30 Hari</button>
          <button className="px-4 py-2 rounded-full bg-primary-container text-on-primary-container text-label-lg font-bold">Batch Ini</button>
        </div>
      ...
      <section className="bg-surface-container-lowest border border-outline-variant rounded-card p-4">
        <div className="flex justify-between items-center mb-1">
          <h2 className="font-headline-sm text-headline-sm">Grafik Kematian Harian</h2>
          <button className="material-symbols-outlined text-on-surface-variant hover:bg-surface-container-low p-2 rounded-full transition-colors">tune</button>
        </div>
        <p className="font-label-md text-label-md text-outline mb-6">7 hari terakhir</p>
      ...
      <section className="bg-surface-container-lowest border border-outline-variant rounded-card overflow-hidden">
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-outline-variant text-body-md">
            ...
            <tr className="hover:bg-surface-container-low transition-colors">
              <td className="py-3 px-4 border-l-4 border-secondary-container">Lantai 2</td>
      ...
      <section className="space-y-2">
        <h2 className="font-label-lg text-label-lg text-outline tracking-widest pt-2">EXPORT DATA</h2>
        <div className="bg-surface-container-lowest border border-outline-variant rounded-card overflow-hidden">
          <div className="flex items-center h-16 px-4 gap-4 border-b border-outline-variant hover:bg-surface-container-low transition-colors cursor-pointer">
            <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center shrink-0">
              <span className="material-symbols-outlined text-green-700 text-[20px]">description</span>
            </div>
            <div className="flex-1">
              <p className="font-label-lg text-label-lg text-on-surface">Excel Spreadsheet</p>
              <p className="text-[11px] text-on-surface-variant">Laporan mendalam .xlsx</p>
            </div>
            <button className="px-3 py-1.5 border border-green-700 text-green-700 text-[12px] font-bold rounded-ui-element active:scale-95 transition-transform">Download</button>
          </div>
          <div className="flex items-center h-16 px-4 gap-4 border-b border-outline-variant hover:bg-surface-container-low transition-colors cursor-pointer">
            <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center shrink-0">
              <span className="material-symbols-outlined text-red-700 text-[20px]">picture_as_pdf</span>
            </div>
            <div className="flex-1">
              <p className="font-label-lg text-label-lg text-on-surface">Dokumen PDF</p>
              <p className="text-[11px] text-on-surface-variant">Siap cetak & arsip .pdf</p>
            </div>
            <button className="px-3 py-1.5 border border-red-700 text-red-700 text-[12px] font-bold rounded-ui-element active:scale-95 transition-transform">Download</button>
          </div>
          <div className="flex items-center h-16 px-4 gap-4 hover:bg-surface-container-low transition-colors cursor-pointer">
            <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
              <span className="material-symbols-outlined text-amber-700 text-[20px]">csv</span>
            </div>
            <div className="flex-1">
              <p className="font-label-lg text-label-lg text-on-surface">Raw CSV Data</p>
              <p className="text-[11px] text-on-surface-variant">Integrasi sistem .csv</p>
            </div>
            <button className="px-3 py-1.5 border border-amber-700 text-amber-700 text-[12px] font-bold rounded-ui-element active:scale-95 transition-transform">Download</button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface-container-lowest border border-outline-variant rounded-card overflow-hidden mb-8">
        <div className="p-4 flex justify-between items-center border-b border-outline-variant">
          <h2 className="font-headline-sm text-headline-sm">Laporan Otomatis</h2>
        ...
        <div className="divide-y divide-outline-variant">
          <div className="p-4 flex items-center justify-between hover:bg-surface-container-low transition-colors cursor-pointer">
            <div className="flex gap-4 items-center">
              <span className="material-symbols-outlined text-outline">event_repeat</span>
              <div>
                <p className="font-label-lg text-label-lg">Laporan Mingguan</p>
                <p className="font-label-md text-label-md text-on-surface-variant">Setiap Senin, 06:00 WIB • Email Aktif</p>
              </div>
            </div>
            <button className="material-symbols-outlined text-on-surface-variant p-2 rounded-full hover:bg-surface-variant transition-colors">edit</button>
          </div>
          <div className="p-4 flex items-center justify-between hover:bg-surface-container-low transition-colors cursor-pointer">
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <p className="font-label-md text-label-md text-on-surface-variant">Setiap Tgl 1, 07:00 WIB • Email Aktif</p>
              </div>
            </div>
            <button className="material-symbols-outlined text-on-surface-variant p-2 rounded-full hover:bg-surface-variant transition-colors">edit</button>
          </div>
